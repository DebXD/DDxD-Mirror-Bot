...
class GoogleDriveHelper:
            ...
            if meta.get("mimeType") == self.__G_DRIVE_DIR_MIME_TYPE:
                ...
                if INDEX_URL is not None:
                    ...
                    if SHORTENER is not None and SHORTENER_API is not None:
                        ...
                        buttons.buildbutton("🏷️ 𝐈𝐧𝐝𝐞𝐱 𝐋𝐢𝐧𝐤", url)
                ...
                if SHORTENER is not None and SHORTENER_API is not None:
                    ...
                    buttons.buildbutton("☁️ 𝐃𝐫𝐢𝐯𝐞 𝐋𝐢𝐧𝐤", durl)
                try:
                    msg += f'\n\n<b>🗄️ Total Size :</b> {get_readable_file_size(int(meta.get("size")))}\n\n▫️Uploaded ✓ \n\n'
                except TypeError:
                    pass
                if INDEX_URL is not None:
    ...
    def drive_list(self, fileName):
        ...
        if response["files"]:
            ...
            buttons = button_build.ButtonMaker()   
            buttons.buildbutton("😃Yes! Found These Results.😊", f"https://telegra.ph/{self.path[0]}")
